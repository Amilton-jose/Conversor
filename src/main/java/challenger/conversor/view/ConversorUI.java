...
public class ConversorUI {
    ...
    private void inicializar() {
        ...
        lblOptionConversion = new JLabel("Escolha a moeda para a qual você deseja girar seu dinheiro");
        optionConversion = new JComboBox<>(new String[]{"Opções..",
                "Real a Dólares", "" +
                "Real a Euros", "" +
                "Real a Libra", "" +
                "Real a Yenes",
